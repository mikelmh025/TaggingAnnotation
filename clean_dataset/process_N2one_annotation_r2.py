...
for human_key in human_data:
    ...
    for asset_key in asset_data:
        ...
        dis_dict, dis_sum = eval_distance(human_data[human_key],asset_data[asset_key],check=temp)
    ...
    matched_asset_paths = [ data_utils.fix_image_subscript(path) for path in matched_asset_paths]
